...
namespace Digitizeit.PaceDistanceSpeedHelper
{
    public static class PaceCalculationHelper
    {
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double minutes/km</returns>
        public static double DistanceMetersInSecondsToMinKm(this decimal distance, int seconds)
        {
            return DistanceMetersInSecondsToMinKm((double)distance, seconds);
        }
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double minutes/(English)mile</returns>
        public static double DistanceMetersInSecondsToMinutesEnglishMile(this decimal distance, int seconds)
        {
            return DistanceMetersInSecondsToMinutesEnglishMile((double)distance, seconds);
        }
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double Km/h</returns>
        public static double DistanceMetersInSecondsToKmHour(this decimal distance, int seconds)
        {
            return DistanceMetersInSecondsToKmHour((double)distance, seconds);
        }
        ...
        public static double DistanceMetersInSecondsToMph(this double distance, int seconds)
        {
            var distancePart = (distance / 1609.344);
            var hour = (seconds / 60.0) / 60.0;
            var ret = distancePart / hour;
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double (english) MPH </returns>
        public static double DistanceMetersInSecondsToMph(this int distance, int seconds)
        {
            return DistanceMetersInSecondsToMph((double)distance, seconds);
        }
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double (english) MPH </returns>
        public static double DistanceMetersInSecondsToMph(this short distance, int seconds)
        {
            return DistanceMetersInSecondsToMph((double)distance, seconds);
        }
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double (english) MPH </returns>
        public static double DistanceMetersInSecondsToMph(this long distance, int seconds)
        {
            return DistanceMetersInSecondsToMph((double)distance, seconds);
        }
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double (english) MPH </returns>
        public static double DistanceMetersInSecondsToMph(this float distance, int seconds)
        {
            return DistanceMetersInSecondsToMph((double)distance, seconds);
        }
        ...
        /// <param name="seconds">Time passed in seconds</param>
        /// <returns>double (english) MPH </returns>
        public static double DistanceMetersInSecondsToMph(this decimal distance, int seconds)
        {
            return DistanceMetersInSecondsToMph((double)distance, seconds);
        }
    }
